      ...
      <div className="grid pc:grid-cols-2 tablet:grid-cols-1 gap-8 mobile:grid-cols-1">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <h3 className="font-body-16-bold text-gray-900">
              ...
              return (
                <div key={event.id}>
                  <div className="py-2">
                    {/* 날짜 색상 조건부 변경 */}
                    <div
                      className={`font-caption-14 mb-1 ${
                        isToday ? 'text-pri-800' : 'text-point-1'
                      }`}
                    >
                      {eventDate.toLocaleDateString('ko-KR')}
                    </div>
                    <div className="font-body-14-regular text-gray-900 hover:text-point-1 flex-1 truncate">
                      {event.title}
                    </div>
                  </div>
