    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="space-y-6">
          <h2 className="text-body-18-medium text-gray-900">기본 정보</h2>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              <label className="block text-body-18-medium text-gray-900 mb-3">
                이름 *
              </label>
              <Input
                type="text"
        ...
        <div className="space-y-6">
          <h2 className="text-body-18-medium text-gray-900">상세 정보</h2>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 border border-gray-300 rounded-md text-body-18-medium text-gray-900 resize-vertical"
            />
          </div>
