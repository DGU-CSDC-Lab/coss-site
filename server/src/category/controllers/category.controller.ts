...
export class CategoryController {
  ...
  @ApiOperation({
    summary: '카테고리 목록 조회',
    description: '계층형 카테고리 목록을 조회합니다.',
  })
  @ApiQuery({
    name: 'parentId',
    required: false,
    description: '부모 카테고리 ID (없으면 최상위 카테고리)',
  })
  @ApiResponse({
    status: 200,
    description: '카테고리 목록',
  ...
  @ApiOperation({
    summary: '카테고리 수정',
    description: '기존 카테고리를 수정합니다. (관리자 전용)',
  })
  ...
  @ApiResponse({
    status: 409,
    description: '하위 카테고리가 있어 삭제할 수 없음',
  })
