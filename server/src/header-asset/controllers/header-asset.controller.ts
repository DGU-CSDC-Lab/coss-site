...
export class HeaderAssetController {
  ...
  @ApiOperation({ 
    summary: '헤더 요소 목록 조회', 
    description: '헤더 요소 목록을 조회합니다. 타입별 필터링과 페이지네이션을 지원합니다.' 
  })
  @ApiResponse({ status: 200, description: '헤더 요소 목록 조회 성공', type: PagedResponse<HeaderAssetResponse> })
  ...
  @ApiParam({ name: 'type', enum: HeaderAssetType, description: '헤더 요소 타입' })
  @ApiResponse({ status: 200, description: '타입별 헤더 요소 조회 성공', type: [HeaderAssetResponse] })
  @Get('api/v1/header-assets/type/:type')
  async getHeaderAssetsByType(@Param('type') type: HeaderAssetType): Promise<HeaderAssetResponse[]> {
  ...
  @ApiResponse({ status: 200, description: '헤더 요소 상세 조회 성공', type: HeaderAssetResponse })
  ...
  @ApiResponse({ status: 201, description: '헤더 요소 생성 성공', type: HeaderAssetResponse })
  ...
  @ApiParam({ name: 'id', description: '헤더 요소 ID' })
  @ApiResponse({ status: 200, description: '헤더 요소 수정 성공', type: HeaderAssetResponse })
